...
const Experience = ({
  ...
  return (
    <div className="group flex flex-col sm:flex-row gap-6 sm:p-6 p-0 rounded-xl mb-2 hover:shadow hover:bg-transparentGrey hover:cursor-pointer">
      <div className="w-[130px] text-xs pt-2">{duration}</div>
